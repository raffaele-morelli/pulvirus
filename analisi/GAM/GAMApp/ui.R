                       ...
                       tabsetPanel(
                         ...
                         tabPanel("Mappa", column(
                           ...
                           shinycssloaders::withSpinner(
                             leaflet::leafletOutput("aqMap", height = "600px"),
                             size = 2,
                             color = "#0080b7"
                           )
                         )),
      ...
      tabsetPanel(
        ...
        tabPanel("Plot",
                 fluidRow(
                   column(
                     12,
                     style = "background-color: #f6f6f6; border-radius: .5em;",
                   ...
                   column(
                     ...
                     radioButtons(
                       "ts_plot_type",
                       "Tipo di plot:",
                       choices = c("Serie", "Pollution rose", "Polar freq", "Boxplot"),
                       inline = T
                     ),
                     conditionalPanel(
                       condition = "input.ts_plot_type=='Boxplot'",
                     ...
                     conditionalPanel(condition = "input.ts_plot_type=='Serie'", plotOutput(
                       "serie", width = "90%", height = "500px"
                     )),
        ...
        tabPanel("Descrittive",
                 fluidRow(column(
                   12, div(DT::dataTableOutput("descrittive"), style = "font-size:90%")
                 ))),
        tabPanel(
          "GAM",
          fluidRow(column(
          ...
          fluidRow(column(
            12,
            plotOutput("residui", width = "98%", height = "600px")
          )),
        ),
        tabPanel("Guida",
                 fluidRow(column(
